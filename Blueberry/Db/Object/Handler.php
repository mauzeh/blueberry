...
abstract class Blueberry_Db_Object_Handler extends Zend_Db_Table_Abstract {
	...
	/**
	 * Do a manual INSERT query because Zend is messing with my UTF-8..
	 */
	public function insert($data)
	{
		$query = new Blueberry_Db_Query_Insert($this->_name, $data);
		return $query->getLastInsertId();
	}

	/**
	 * Do a manual UPDATE query because Zend is messing with my UTF-8..
	 */
